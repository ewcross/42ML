...
#    Updated: 2020/05/10 14:06:13 by ecross           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
mlogr = MLogR(thetas, alpha=0.0001, n_cycle=10000)
for i in range(4):
    mlogr.thetas = thetas
...
final = np.concatenate((origins_test, labels), axis=1)
print(final)
...
#    print(f'planet {i} accuracy sklearn:', accuracy_score(y_labelled, y_hat_labelled))
#    print(f'planet {i} precision (fps)  :', precision_score_(y_labelled, y_hat_labelled))
#    print(f'planet {i} precision sklearn:', precision_score(y_labelled, y_hat_labelled))
#    print(f'planet {i} recall (fns)  :', recall_score_(y_labelled, y_hat_labelled))
#    print(f'planet {i} recall sklearn:', recall_score(y_labelled, y_hat_labelled))
#    print(f'planet {i} f1        :', f1_score_(y_labelled, y_hat_labelled))
#    print(f'planet {i} f1 sklearn:', f1_score(y_labelled, y_hat_labelled))
#    print('-----------------------------')
